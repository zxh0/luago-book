...
52		| 4.2.1		| 图4-3								| 左边中间方框中写了`d`					| 应该是`b`								| ![起床睡觉][起床睡觉]	|
...
156		| 8.4.2		| 第一段话第二行						|由于要接收`f()`的全部返回值				|由于要接收`g()`的全部返回值				| ![ShakeM][ShakeM]		|
...
187 	| 10.1.2 	| 第一段话第一行						| 我们再用“luc -l -l”分析…… 				| 我们再用“luac -l -l”分析……				| ![Deng][Deng]			|
192 	| 10.2.2 	| 倒数第二段话倒数第三行				| 读者打开luaStack.go文件…… 				| 读者打开lua_stack.go文件……				| ![Deng][Deng]			|
...
227 	| 12.2.1 	| 第一段话第一行						| 请读者打开luaTable.go文件…… 			| 请读者打开lua_table.go文件……			| ![Deng][Deng]			|
228 	| 12.2.2 	| 倒数第一段话第二行					| （和luaTable.go文件…… 					| （和lua_table.go文件……					| ![Deng][Deng]			|
